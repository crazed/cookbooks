...
# $Id: zabbixapi.rb 188 2010-07-16 07:10:31Z nelsonab $
# $Revision: 188 $
##########################################
...
class ZbxAPI_GeneralError < RuntimeError
end
...
class ZbxAPI
  ...
  attr_accessor :method, :params, :debug_level
